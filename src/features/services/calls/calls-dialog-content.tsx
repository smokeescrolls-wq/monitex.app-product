...
function CallsIconGlow() {
  return (
    <div className="relative grid h-10 w-10 place-items-center rounded-2xl border border-white/10 bg-emerald-500/12">
      <div className="absolute inset-0 rounded-2xl shadow-[0_0_22px_rgba(16,185,129,0.22)]" />
      <Phone className="relative h-5 w-5 text-emerald-200" />
    </div>
  );
}
...
export default function CallsDialogContent({
  ...
  return (
    <div className="space-y-4">
      {!session ? (
        <>
          <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 p-4 shadow-[0_0_22px_rgba(16,185,129,0.10)]">
            <CallsIconGlow />

            <div className="min-w-0">
              <p className="text-sm font-semibold text-white/90">Calls</p>
              <p className="text-xs text-white/55">
                Analyze exported/authorized call logs (simulation)
              </p>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 rounded-2xl border border-emerald-500/25 bg-black/35 px-3 py-2">
          ...
          <label className="flex cursor-pointer items-center gap-3 rounded-2xl border border-white/10 bg-black/25 px-4 py-3 text-xs text-white/70">
            ...
            />
            I confirm the call log is mine or I have explicit authorization for
            analysis.
          </label>
        ...
        <>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5 shadow-[0_0_22px_rgba(16,185,129,0.10)]">
          ...
          <div className="rounded-2xl border border-white/10 bg-black/25 p-4">
            ...
            >
              ...
              {credits < CALLS_FLOW.accelerateCost
                ? "Not enough credits"
                : `Accelerate for ${CALLS_FLOW.accelerateCost} credits`}
            </Button>
